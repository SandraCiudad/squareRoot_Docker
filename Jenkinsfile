        ...
        stage('Tests') {
            ...
            steps {
                ...
                dir("${env.WORKSPACE}") {
                    ...
                    // CPPCheck Code Analysis
                    sh '''cppcheck --enable=all --inconclusive --html --html-version=2 `find "." -name "*.c*" | grep -v ".cccc" | grep -v ".svn" | grep -v ".settings" | grep -v ".cproject"` 2> reports/project_cppcheck.html'''
